...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath 
{
	...
	UIAlertView  *alert = [[UIAlertView alloc]initWithTitle:@"you tapped the row." message:[NSString stringWithFormat:@"you tapped %@.",rowString]delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil];
	[alert show];
	[alert release];
