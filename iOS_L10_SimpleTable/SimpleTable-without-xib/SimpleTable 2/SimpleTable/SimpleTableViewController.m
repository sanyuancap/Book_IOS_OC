...
@synthesize m_pArrayListDataNew = _m_pArrayListDataNew;

- (void)dealloc
{
    [_m_pArrayListDataNew release];
...
- (void)viewDidLoad
{
    ...
    self.m_pArrayListDataNew = [[NSArray alloc]
                             initWithObjects:@"Goodmao", @"Maoyingyong", nil];
...
//#warning Incomplete method implementation.
    ...
    switch (section)
    {
        ...
        case 1:
        {
            return [self.m_pArrayListDataNew count];
        }
            break;
...
{    
    switch (section)
    {
        case 0:
        {
            return [NSString stringWithFormat:@"%@ %d", @"Number", section];
        }
            break;
        case 1:
        {
            return [NSString stringWithFormat:@"%@ %d", @"Name", section];
        }
            break;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (nSection)
    {
        ...
        {
            // 获取列表中指定行的数据
            cell.textLabel.text = [self.m_pArrayListDataNew objectAtIndex:nRow];
