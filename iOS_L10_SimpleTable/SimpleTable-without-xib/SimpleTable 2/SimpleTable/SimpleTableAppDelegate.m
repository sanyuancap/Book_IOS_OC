...
@synthesize m_pSTableVC = _m_pSTableVC;

- (void)dealloc
{
    [_m_pSTableVC release];
    [_window release];
    [super dealloc];
}
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.m_pSTableVC = [[SimpleTableViewController alloc] init];
    self.window.rootViewController = self.m_pSTableVC;
